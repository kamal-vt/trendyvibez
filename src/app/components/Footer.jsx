...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-tr  from-[#0f0c29] via-[#302b63] to-[#24243e] text-white rounded-t-[30px] sm:rounded-t-[50px] pt-10 b-4 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        {/* Bottom Bar */}
        <div className="mt-8 py-5 sm:mt-12 pt-6 border-t border-white/10 flex flex-col items-center justify-between gap-4 text-white/60 text-xs md:text-sm">
